...
- (IBAction)addNightAndLighthouse:(id)sender {
    ...
    CLLocationDistance nightCapRadii[] = {
        ...
        nightRadius * (1.0 - 18.0 / 180), // nautical twilight
        nightRadius * (1.0 - 12.0 / 180), // astronomical twilight
        nightRadius * (1.0 - 6.0 / 180), // night
    };
...
- (NSColor *)mapView:(MGLMapView *)mapView fillColorForCircleAnnotation:(MGLCircle *)annotation {
    return annotation.title ? [NSColor blackColor] : [NSColor whiteColor];
}
